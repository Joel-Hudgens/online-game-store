 ...
 * Lecture: T, Th 10: 30
 * Description: This class is the main driver to a Online Game Store.
 * This class uses input readers and print statements to create an interface to interact with the store
 */
		...
		while (!quit) {
			...
			try {
				...
				switch (choice.toUpperCase()) {
					...
					case "A":
						System.out.println("Enter game details: name, description, price, downloads (separated by commas)");
